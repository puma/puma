...
class TestConfigFile < PumaTest
  ...
  def test_options_raises_not_loaded_error_when_not_loaded
    conf = Puma::Configuration.new
    ...
    assert_equal "ensure load is called before accessing options", error.message
  end
  ...
  def test_options_succeeds_when_loaded_and_clamped
    conf = Puma::Configuration.new
    conf.load
    conf.clamp
  ...
  def test_config_files_succeeds_when_loaded_and_clamped
    conf = Puma::Configuration.new
    conf.load
    conf.clamp
  ...
  def test_clamp_succeeds_when_loaded
    ...
    assert_kind_of Puma::UserFileDefaultOptions, conf.clamp
  end
