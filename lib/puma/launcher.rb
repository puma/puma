...
module Puma
  ...
  class Launcher
    ...
    def integrate_with_systemd
      ...
      require 'sd_notify'
      return log "Systemd integration failed. It looks like you're trying to use systemd notify but don't have ruby-sdnotify gem installed" unless ENV["SD_NOTIFY"] && defined?(SdNotify)
