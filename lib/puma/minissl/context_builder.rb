      ...
      def context
        ...
        if defined?(JRUBY_VERSION)
          ...
          if params['key'].nil? && params['key_pem'].nil?
            log_writer.error "Please specify the SSL key via 'key=' or 'key_pem=', or require the 'localhost' gem in your Puma config for automatic self-signed certificates."
          end
