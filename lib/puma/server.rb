...
module Puma
  ...
  class Server
    ...
    def graceful_shutdown
      shutdown_debugger = if options[:shutdown_debug]
        lambda do |threads, message|
          total = threads.size
      ...
      if shutdown_debugger && options[:shutdown_debug] != :on_force
        shutdown_debugger.call(@thread_pool.workers, "Shutdown initiated")
        shutdown_debugger = nil
      end
      ...
      @thread_pool.shutdown options[:force_shutdown_after], shutdown_debugger
    end
