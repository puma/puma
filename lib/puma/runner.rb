...
module Puma
  ...
  class Runner
    ...
    def output_header(mode)
      ...
      silence_version_header = @options[:silence_version_header]

      log "Puma starting in #{mode} mode..."
      log "* Puma version: #{Puma::Const::PUMA_VERSION} (#{ruby_engine}) (\"#{Puma::Const::CODE_NAME}\")" unless silence_version_header
