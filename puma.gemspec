...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_unix_socket.rb", "test/test_http10.rb", "test/test_ws.rb", "test/test_persistent.rb", "test/test_rack_server.rb", "test/test_puma_server.rb", "test/test_integration.rb", "test/test_config.rb", "test/test_cli.rb", "test/test_rack_handler.rb", "test/test_thread_pool.rb", "test/test_app_status.rb", "test/test_http11.rb"]
