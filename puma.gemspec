...
Gem::Specification.new do |s|
  ...
  s.description = "Puma is a simple, fast, multi-threaded, and highly parallel HTTP 1.1 server for Ruby/Rack applications."
  s.summary = "Ruby web server built for parallelism."
  s.email = ["evan@phx.io"]
